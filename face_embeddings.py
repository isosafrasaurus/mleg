...
# InceptionResnetV1 for face embeddings (pretrained on VGGFace2)
...
image_files = sorted([f for f in os.listdir(input_folder) if f.lower().endswith(image_extensions)])
...
for filename in image_files:
    ...
    temp_path = os.path.join(output_folder, "temp_display.jpg")
